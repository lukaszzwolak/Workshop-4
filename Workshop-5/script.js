const apikey = "1609890f-7ee5-4f59-bc2b-d326743385a4";
const apihost = "https://todo-api.coderslab.pl";

if (apikey == "") {
    alert(
        `Wejdź na https://todo-api.coderslab.pl/apikey/create oraz skopiuj token i wklej do stałej "apikey", w pliku script.js. Inaczej nic się nie uda!`,
    );
}
